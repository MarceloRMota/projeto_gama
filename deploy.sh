...
[ec2-k8s-w3]
$ID_W3
" > ../ansible/k8s-install-masters_e_workers/hosts
...
" > ../ansible/k8s-install-masters_e_workers/haproxy/haproxy.cfg
...
ff02::3 ip6-allhosts
" > ../ansible/k8s-install-masters_e_workers/host/hosts


cd ../ansible/k8s-install-masters_e_workers

ANSIBLE_OUT=$(ansible-playbook -i hosts provisionar.yml -u ubuntu)
...
ansible-playbook -i hosts provisionar-k8s-master-auto-shell.yml -u ubuntu
